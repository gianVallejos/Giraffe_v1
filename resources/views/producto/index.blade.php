                    ...
                    <div class="panel-body" style="padding-top: 29px;">
                        ...
                        <form class="form-horizontal" action="{{ route('productoindex') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="nombre"
                                       class="col-md-2 col-md-offset-1 col-xs-2 col-xs-offset-1 control-label">Nombres</label>
                                <div class="col-md-8 col-xs-8">
                                    <input id="nombre" type="text" class="form-control" name="nombre"
                                           value="{{ old('nombre')}}" placeholder="Nombres" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-8">
                                    <input id="descripcion" type="text" class="form-control" name="descripcion"
                                           value="{{ old('descripcion')}}" placeholder="Descripción" autofocus>
                            ...
                            <div class="form-group">
                                <label for="precio"
                                       class="col-md-2 col-md-offset-1 col-xs-2 col-xs-offset-1 control-label">Precio</label>
                                <div class="col-md-8 col-xs-8">
                                    <input id="precio" type="number" class="form-control" name="precio"
                                           value="{{ old('precio')}}" placeholder="Precio" min="0" step=".1" required
                                           autofocus>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="padding-bottom: 13px;">
                            ...
                            <div id="table-wrapper">
                                <div id="table-scroll"
                                     style="max-height: 50vh; margin-top: 19px; padding-left: 13px; padding-right: 13px;">
                                        ...
                                        @foreach( $data as $row )
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ route('productos.destroy', $row->id) }}"
                                                          method="post">
